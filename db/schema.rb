...
ActiveRecord::Schema[7.0].define(version: 2024_04_27_012219) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.string "recipient_request"
    t.string "video_type"
    t.bigint "user_id", null: false
    t.bigint "hologram_id", null: false
    t.index ["hologram_id"], name: "index_bookings_on_hologram_id"
  ...
  create_table "holograms", force: :cascade do |t|
    t.string "actor"
  ...
  add_foreign_key "bookings", "holograms"
